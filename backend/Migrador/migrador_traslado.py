...
class Migrador_traslado:
    ...
    def _construir_queries(self):
        ...
        SELECT
          OWTR."DocEntry", OWTR."DocNum", OWTR."DocDate", OWTR."Filler", OWTR."ToWhsCode", OWTR."U_SYP_MDTD", OWTR."U_SYP_MDSD", OWTR."U_SYP_MDCD", OWTR."ObjType", OWTR."CardName", OWTR."U_BPP_FECINITRA",
        ...
        WHERE
          {self._formato_fecha_hana('OWTR."DocDate"')} = '{fecha_str}'
          AND OWTR."CANCELED" = 'N'
          AND OWTR."U_SYP_STATUS" = 'V'
          AND OWTR."U_SYP_MDSD" IS NOT NULL
          AND OWTR."U_SYP_MDCD" IS NOT NULL
          AND OWTR."Filler" IN ('15', '16')
          AND OWTR."ToWhsCode" IN ('01', '09', 'ALM07')
        ;
        """
        consulta_owhs = f"""
